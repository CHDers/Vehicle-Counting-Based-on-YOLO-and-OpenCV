# https://www.bilibili.com/video/BV1NqWSeNErH
...
# 指定多边形的顶点坐标
polygonPoints = np.array(
    [[710, 200], [1110, 200], [810, 400], [410, 400]], dtype=np.int32)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if not success:
            ...
            break
        #  绘制线段
        cv2.line(frame, (0, int(frame_height/2)),
                 (int(frame_width), int(frame_height/2)), (0, 0, 255), 3)
        ...
        if videoWriter is None:
            ...
            videoWriter = cv2.VideoWriter(
                RESULT_PATH, fourcc, fps, (int(frame_width), int(frame_height)))
