...
tracker = Sort(max_age=20)  # 20 frames to forget the object
...
while True:
    ...
    cv2.line(frame, (line_left_road_x1, line_left_road_y),
             (line_left_road_x2, line_left_road_y), (0, 0, 255))
    cv2.line(frame, (line_right_road_x1, line_right_road_y),
             (line_right_road_x2, line_right_road_y), (0, 0, 255))
    ...
    for result in results:
        ...
        for obj in tracked_objects:
            ...
            cvzone.putTextRect(
                frame, f'ID: {obj_id}', (confidence_pos_x1, confidence_pos_y1), 1, 1)
            ...
            if line_left_road_y - 10 < center_y < line_left_road_y + 10 and line_left_road_x1 < center_x < line_left_road_x2:
                if not obj_id in vehicle_left_road_id_count:
                    ...
                    cv2.line(frame, (line_left_road_x1, line_left_road_y),
                             (line_left_road_x2, line_left_road_y), (0, 255, 0), 2)
            ...
            if line_right_road_y - 10 < center_y < line_right_road_y + 10 and line_right_road_x1 < center_x < line_right_road_x2:
                if not obj_id in vehicle_right_road_id_count:
                    ...
                    cv2.line(frame, (line_right_road_x1, line_right_road_y),
                             (line_right_road_x2, line_right_road_y), (0, 255, 0), 2)

    cvzone.putTextRect(frame, f'Car Left Road Count: {len(vehicle_left_road_id_count)}', (
        50, 50), 2, 2, offset=20, border=2, colorR=(140, 57, 31), colorB=(140, 57, 31))
    cvzone.putTextRect(frame, f'Car Right Road Count: {len(vehicle_right_road_id_count)}', (
        width - 460, 50), 2, 2, offset=20, border=2, colorR=(140, 57, 31), colorB=(140, 57, 31))
